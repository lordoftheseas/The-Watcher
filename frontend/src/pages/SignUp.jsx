    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Start monitoring threats in real-time</p>
        </div>
        ...
        {oauthEnabled && (
          <>
            ...
            <div className="social-login">
              <button className="btn-social" onClick={handleGoogleSignUp} type="button" disabled={loading}>
              ...
              <button className="btn-social" onClick={handleGitHubSignUp} type="button" disabled={loading}>
                <svg viewBox="0 0 24 24" width="20" height="20">
